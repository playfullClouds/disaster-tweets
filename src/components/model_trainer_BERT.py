...
class ModelTrainerConfig:
    ...
    best_model_path: str = os.path.join(destination_dir, 'best_model.pt')
...
class ModelTrainer:
    ...
    def train_model(self):
        ...
        try:
            ...
            if os.path.exists(os.path.join(model_save_dir, 'model.safetensors')):
                os.rename(os.path.join(model_save_dir, 'model.safetensors'), os.path.join(model_save_dir, 'pytorch_model.bin'))
